        ...
        <TableBody>
          {specialBuildings.map(specialBuilding => (
            <TableRow key={specialBuilding.id}>
              ...
              <TableCell>
                {specialBuilding.buildingPointsPut} / {specialBuilding.buildingPointsRequired}
              </TableCell>
              <TableCell>
                <Input
                  type="number"
                ...
                <ButtonGroup>
                  ...
                  <Button
                    onClick={() =>
                      handleMaxInput(specialBuilding.id, specialBuilding.buildingPointsRequired - specialBuilding.buildingPointsPut)
                    }
                  >
                    Max
                  </Button>
                  <Button variant="contained" onClick={() => handleDemolish(specialBuilding.id)} color="error">
                    Demolish
                  </Button>
                </ButtonGroup>
              </TableCell>
