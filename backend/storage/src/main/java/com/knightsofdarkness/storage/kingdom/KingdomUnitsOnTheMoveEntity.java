...
@Entity
public class KingdomUnitsOnTheMoveEntity {
    @Id
    private UUID id;
    ...
    public KingdomUnitsOnTheMoveEntity()
    {
    }

    public KingdomUnitsOnTheMoveEntity(UUID id, KingdomEntity kingdom, SpecialBuildingType buildingType, int level, int buildingPointsPut, int buildingPointsRequired, boolean isMaxLevel)
    {
        this.id = id;
